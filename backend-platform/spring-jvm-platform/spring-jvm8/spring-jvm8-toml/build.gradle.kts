catalog {
    versionCatalog {
        ...
        backendSpring5.logstash.logback.encoder.java8.also {
        ...
        backendSpring5.jaxb.plugins.runtime.java8.also {
            library("jaxb-plugins-runtime", it.get().toString())
        }
        backendSpring5.jaxb.plugins.java8.also {
