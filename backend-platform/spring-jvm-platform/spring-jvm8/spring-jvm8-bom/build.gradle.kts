dependencies {
    ...
    constraints {
        ...
        api(backendSpring5.logstash.logback.encoder.java8)
        ...
        api(backendSpring5.jaxb.plugins.runtime.java8)
        api(backendSpring5.jaxb.plugins.java8)
        ...
        // --> testing
        api(backendSpring5.testng.java8)
        api(backendSpring5.springmockk.spring5)
        api(backendSpring5.wiremock.jre8)
